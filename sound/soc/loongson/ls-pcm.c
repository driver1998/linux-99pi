...
#ifdef CONFIG_SND_LS_2K300
int ls_pcm_trigger(struct snd_soc_component *component, struct snd_pcm_substream *substream, int cmd)
{
...
#ifdef CONFIG_SND_LS_2K300
snd_pcm_uframes_t
ls_pcm_pointer(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
...
int __ls_pcm_prepare(struct snd_soc_component *component, 
...
#ifdef CONFIG_SND_LS_2K300
int __ls_pcm_open(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
...
#ifdef CONFIG_SND_LS_2K300
int __ls_pcm_close(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	struct ls_runtime_data *prtd = runtime->private_data;
	int irq;
...
static int ls_pcm_mmap(struct snd_soc_component *component, struct snd_pcm_substream *substream,
...
void ls_pcm_free_dma_buffers(struct snd_soc_component *component, struct snd_pcm *pcm)
{
	struct snd_pcm_substream *substream;
	...
	struct snd_pcm_hw_params *params)
{
	...
	struct ls_runtime_data *prtd = runtime->private_data;
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct ls_pcm_dma_params *dma = snd_soc_dai_get_dma_data(snd_soc_rtd_to_cpu(rtd, 0), substream);
...
static int ls_pcm_hw_free(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
...
static int ls_soc_pcm_new(struct snd_soc_component *component, struct snd_soc_pcm_runtime *rtd)
{
